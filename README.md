...
<br><br>
Word2Vec and GloVe are some of the most popular technique to learn word embeddings. In this project, we are going to build word2vec and GloVe algorithms from scratch using NumPy.
